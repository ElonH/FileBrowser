...
# GOARCH=ppc64el GOPPC64=power8 go build -a -ldflags '-s -w' -o ${build_dir}/ppc64el_power8 $main_file
# upx --lzma -o ${comp_dir}/ppc64el_power8 ${build_dir}/ppc64el_power8

# GOARCH=ppc64el GOPPC64=power9 go build -a -ldflags '-s -w' -o ${build_dir}/ppc64el_power9 $main_file
# upx --lzma -o ${comp_dir}/ppc64el_power9 ${build_dir}/ppc64el_power9
