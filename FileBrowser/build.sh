...
## workflow: https://filebrowser.xyz/contributing
code_source=${PWD}/src/filebrowser
# git clone https://github.com/filebrowser/filebrowser ${code_source}
main_file=${code_source}/main.go
build_dir=${PWD}/build
comp_dir=${PWD}/comp
...
GOARCH=mipsle GOMIPS=hardfloat go build -a -ldflags '-s -w' -o ${build_dir}/mipsle_hardfloat $main_file
upx --lzma -o ${comp_dir}/mipsle_hardfloat ${build_dir}/mipsle_hardfloat

GOARCH=mipsle GOMIPS=softfloat go build -a -ldflags '-s -w' -o ${build_dir}/mipsle_softfloat $main_file
upx --lzma -o ${comp_dir}/mipsle_softfloat ${build_dir}/mipsle_softfloat
...
GOARCH=mips64le GOMIPS64=hardfloat go build -a -ldflags '-s -w' -o ${build_dir}/mips64le_hardfloat $main_file
# upx --lzma -o ${comp_dir}/mips64le_hardfloat ${build_dir}/mips64le_hardfloat
cp ${build_dir}/mips64le_hardfloat ${comp_dir}/mips64le_hardfloat

GOARCH=mips64le GOMIPS64=softfloat go build -a -ldflags '-s -w' -o ${build_dir}/mips64le_softfloat $main_file
# upx --lzma -o ${comp_dir}/mips64le_softfloat ${build_dir}/mips64le_softfloat
cp ${build_dir}/mips64le_softfloat ${comp_dir}/mips64le_softfloat
